...
const PublicationModalContent: React.FC<{ pub: Pub }> = ({ pub }) => {
    return (
        <div className="flex flex-col gap-10 py-10 mmd:px-[10px] px-[120px]">
            <div className="flex flex-col gap-5 pb-10 border-b-2 border-gray-200 sm:justify-center sm:items-center ">
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="md:text-headingMd text-heading2Xl font-semibold text-black-900 sm:text-center">
                        {pub.name}
                    </h1>
                    <p className="md:text-bodySm sm:text-center font-light">{pub.authors}</p>
                    <div className="flex sm:flex-col flex-row gap-2 sm:gap-0 text-bodyMd md:text-bodySm text-gray-700 font-light sm:text-center">
                        <p>{pub.journal}</p>
                ...
                <div className="flex flex-col gap-3 rounded-[4px] p-5 bg-gray-50 border-1 border-gray-200 w-full">
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <p className="text-bodyMd sm:text-bodySm break-all">https://doi.org/{pub.doi}</p>
                    </div>
                </div>
            </div>
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-3 rounded-[4px] p-5 bg-gray-50 border-1 border-gray-200">
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <p className="text-bodyMd sm:text-bodySm break-all">https://www.github.com</p>
                    </div>
                </div>
                <div className="flex flex-col gap-3 rounded-[4px] p-5 bg-gray-50 border-1 border-gray-200">
                    <div className="flex flex-row">
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <p className="text-bodyMd sm:text-bodySm break-all">https://www.codeocean.com</p>
                    </div>
                </div>
            </div>
            <div className="flex flex-col gap-5 flex-auto">
                ...
                <div className="flex flex-col gap-3 rounded-[4px] p-5 bg-gray-50 border-1 border-gray-200">
                    ...
                    <div className="flex flex-row gap-2 items-center">
                        ...
                        <p className="text-bodyMd sm:text-bodySm break-all">
