...
const HeaderSection: React.FC<{
    ...
    // PDF state to enforce rerender
    const [pdfObj, setPdfObj] = useState<string>(pdf);
    ...
    const uploadPDF = async () => {
        ...
        // After a successful/unsuccessful pdf upload set the File to null
        setFile(null);
    };
    ...
    return (
        <div className="flex flex-col gap-5 pb-10 border-b-2 border-gray-200 mmd:justify-center mmd:items-center">
            ...
            <div className="flex flex-col gap-2">
                ...
                {abstract && (
                    <div className="flex items-start flex-col gap-1 mmd:gap-0 md:text-bodySm text-gray-700 font-light mmd:text-center">
                        <p
