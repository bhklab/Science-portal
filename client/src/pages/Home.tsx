	...
	return (
		<>
			<div className={`transform ${visible ? 'ml-[320px]' : 'ml-0'} duration-300 ease-in-out`}>
				<Sidebar visible={visible} position="left" onHide={() => {}} className="z-20 w-[320px] mt-[130px] bg-white shadow-sm border-r-1 border-gray-200 custom-sidebar p-sidebar-header" modal={false} showCloseIcon={false}>
					<div className='p-5 flex flex-col gap-8'>
						<h2 className='text-headingLg text-black-900 font-semibold'>Filters</h2>
						<div className='flex flex-col gap-2'>
							<h3 className='text-headingMd text-black-900 font-semibold'>
								Lab
							</h3>
							<Dropdown
								value={labFilter}
						...
						<div className='flex flex-row gap-5 justify-between align-middle text-center'>
								<div className='flex flex-col gap-2 w-[130px]'>
									<h2 className='text-heading2Xl font-semibold text-gray-700'>
										50
									</h2>
									<h3 className='text-bodyMd text-black-900'>
										Publications
									</h3>
								</div>
								<div className='flex flex-col gap-2 w-[130px]'>
				...
				<div id='search-bar' className="fixed top-16 w-full shadow-sm px-16 py-3 flex flex-row gap-4 bg-white z-40">
					{
						visible ? (
